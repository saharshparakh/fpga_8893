...
#define XTOP_KERNEL_CONTROL_ADDR_B_R_DATA   0x1c
#define XTOP_KERNEL_CONTROL_BITS_B_R_DATA   64
#define XTOP_KERNEL_CONTROL_ADDR_SUM_R_DATA 0x28
#define XTOP_KERNEL_CONTROL_BITS_SUM_R_DATA 64
