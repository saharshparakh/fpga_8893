...
if {[file isfile top_kernel.autotvin.dat]} {
	file delete -force top_kernel.autotvin.dat
}

if {[file isfile top_kernel.autotvout.dat]} {
	file delete -force top_kernel.autotvout.dat
}
