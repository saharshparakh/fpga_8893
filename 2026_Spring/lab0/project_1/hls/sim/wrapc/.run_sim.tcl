...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "top_kernel.autotvin.dat"
	set constFileTvOut       "top_kernel.autotvout.dat"
	set constFileHdlTvIn     "top_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "top_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
