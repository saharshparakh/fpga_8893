...
#define AUTOTB_TVOUT_b_r "../tv/cdatafile/c.top_kernel.autotvout_b_r.dat"
#define AUTOTB_TVIN_sum_r "../tv/cdatafile/c.top_kernel.autotvin_sum_r.dat"
#define AUTOTB_TVOUT_sum_r "../tv/cdatafile/c.top_kernel.autotvout_sum_r.dat"
...
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.top_kernel.autotvout_b.dat"
#define AUTOTB_TVIN_sum "../tv/cdatafile/c.top_kernel.autotvin_sum.dat"
...
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.top_kernel.autotvout_b.dat"
#define AUTOTB_TVOUT_PC_sum "../tv/rtldatafile/rtl.top_kernel.autotvout_sum.dat"
...
extern "C"
void apatb_top_kernel_hw(void* __xlx_apatb_param_a_r, void* __xlx_apatb_param_b_r, void* __xlx_apatb_param_sum_r)
{
  ...
  static hls::sim::Byte<4> __xlx_offset_byte_param_b_r;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_b_r),
#endif
  };
  port1.param = &__xlx_offset_byte_param_b_r;

  static hls::sim::Byte<4> __xlx_offset_byte_param_sum_r;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_sum_r),
#endif
  };
  port2.param = &__xlx_offset_byte_param_sum_r;
  ...
  port3.param = { __xlx_apatb_param_a_r };
  port3.mname = { "a_r" };
  port3.nbytes = { 400 };
  ...
  port4.param = { __xlx_apatb_param_b_r };
  port4.mname = { "b_r" };
  port4.nbytes = { 400 };
  ...
  port5.param = { __xlx_apatb_param_sum_r };
  port5.mname = { "sum_r" };
  port5.nbytes = { 400 };
  ...
  try {
    ...
    top_kernel_hw_stub_wrapper(__xlx_apatb_param_a_r, __xlx_apatb_param_b_r, __xlx_apatb_param_sum_r);
